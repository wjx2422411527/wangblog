...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <button class="layui-btn" onclick="question_add('添加问题','{{route('add')}}','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
