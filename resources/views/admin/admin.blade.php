...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <button class="layui-btn" onclick="admin_add('添加用户','{{route('adminadd')}}','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
